...
public class ObjectSaveData {
    ...
    public ObjectSaveData withDataJsonFile(java.lang.String dataJsonFile) {
        this.dataJsonFile = dataJsonFile;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((("ObjectSaveData"+" [type=")+ type)+", dataJsonFile=")+ dataJsonFile)+", name=")+ name)+", objid=")+ objid)+", meta=")+ meta)+", hidden=")+ hidden)+", additionalProperties=")+ additionalProperties)+"]");
    }
